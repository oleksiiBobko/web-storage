...
import com.bobko.album.service.UserService;
...
public class RegistrationController {
    ...
    public String createNewUser  (
            ...
            //check empty fields
            if ((user == null) || user.getPw().isEmpty() || user.getUsrName().isEmpty()) {
            ...
            messageDigest.update(user.getPw().getBytes(),0, user.getPw().length());  
            ...
            if((checkUser != null) && (checkUser.getUsrName().equalsIgnoreCase(user.getUsrName()))) {
                return "redirect:/registration?error=true";
            }
            try {
