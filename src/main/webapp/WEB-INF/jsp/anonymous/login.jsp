	...
	<div class="panel-body">
		<form class="form-signin" name="login" method="post"
			...
			<div class="form-group">
				...
				<input id="email" placeholder="Email address" class="form-control input-sm" name="j_username"
				type="text">
			</div>
			<div class="form-group">
			<small>Password</small>
			<a href="#"><small>Forgot password?</small></a>
				<input class="form-control input-sm" placeholder="Password" name="j_password"
