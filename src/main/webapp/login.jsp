					...
					<table class="login" style="margin-left: auto; margin-right: auto;">
                        ...
                        <tr>
                            <td>
                                ...
                                <input id="email" tabindex="1" class="inputtext" name="j_username" type="text">
                            </td>
                        </tr>
						<tr>
							<td>
                                ...
                                <input tabindex="2" class="inputtext" name="j_password" id="password" type="password">
                            </td>
						</tr>
						...
						<tr>
							...
							<p class="mtop025 mbottom0 smalltxt">
                                <a href="https://www.survs.com/app/wa/Password/forgot">Forgot password?</a>
                        ...
                        <tr>
                            <td>
                                <p class="mtop025 mbottom0 smalltxt">
                                    <input name="remember" id="rememberMe" tabindex="3" type="checkbox"> <label
                        ...
                        <tr>
                            ...
                            <input class="public-button" tabindex="4" type="submit" value="<spring:message code="label.login" />" />
                            </td>
						</tr>
					    </tbody>
                    </table>
